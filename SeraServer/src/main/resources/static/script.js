const IP_ADDRESS = "25.45.128.215"//"192.168.194.212"//"10.242.171.157"
const PORT = "8080"
const root_endpoint = "http://"+IP_ADDRESS+":"+PORT+"/sera";
let MONITOR_REFRESH_RATE = 0.5; //Saniye cinsinden refresh
...
getAll();
setInterval(getAll,MONITOR_REFRESH_RATE*1000);
getConfig();
setInterval(getConfig,MONITOR_REFRESH_RATE*1000);
